...
public class AuthenticationControllerTest extends TestDataProducer {
  ...
  public void testAuthenticate() throws Exception {
    ...
    final String listAsXmlString =
                                 this.xmlConverter.getObjectMapper().writeValueAsString(ProfileModelEdoMapper.toEdo(authenticationSession));

    this.mockMvc
                .perform(MockMvcRequestBuilders.post(IflowRestPaths.ProfileModule.AUTHENTICATION_AUTHENTICATE)
