...
public class CompanyControllerTest extends TestDataProducer {
  ...
  public void testReadUserList() throws Exception {
    ...
    when(this.tokenUserDataManager.getUserListByToken(any(), any(String.class))).thenReturn(userList);
    ...
    verify(this.tokenUserDataManager, times(1)).getUserListByToken(any(), any(String.class));
  }
  ...
  public void testReadUserGroupList() throws Exception {
    ...
    when(this.tokenUserDataManager.getUserGroupListByToken(any(), any(String.class))).thenReturn(list);
    ...
    verify(this.tokenUserDataManager, times(1)).getUserGroupListByToken(any(), any(String.class));
  }
  ...
  public void testReadDepartmentList() throws Exception {
    ...
    when(this.tokenUserDataManager.getDepartmentListByToken(any(), any(String.class))).thenReturn(list);
    ...
    verify(this.tokenUserDataManager, times(1)).getDepartmentListByToken(any(), any(String.class));
  }

  @Test
  @WithMockUser(username = "user1", password = "pwd", roles = RestAccessRoles.Companies.COMPANIES_SAVE)
  ...
  @Test
  @WithMockUser(username = "user1", password = "pwd", roles = RestAccessRoles.Companies.COMPANIES_UPDATE)
