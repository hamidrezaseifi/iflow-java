...
public class DepartmentGroupController {
  ...
  public ResponseEntity<DepartmentGroupEdo> readById(@PathVariable(name = "identity") final String identity,
    ...
    final DepartmentGroup model = this.tokenUserDataManager.getDepartmentGroupById(headerTokenId, identity);
  ...
  public ResponseEntity<UserListEdo> readUserList(@PathVariable(name = "identity") final String identity,
    ...
    final List<User> list = this.tokenUserDataManager.getAllUserListByDepartmentGroupId(headerTokenId, identity);
