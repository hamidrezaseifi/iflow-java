...
public class IflowRestPaths {
  ...
  public static class CoreModule {
    ...
    public static final String WORKFLOWMESSAGE_CHANGE_WORKFLOWMESSAGE_STAUS =
                                                                            "/workflowmessage/changestatus/{workflowid}/{stepid}/{userid}/{status}";
    ...
    public static URI CHANGE_WORKFLOWMESSAGE_WORKFLOWMESSAGE_STAUS(final Long workflowid, final Long stepid, final Long userid, final int status) {
  ...
  public static class WorkflowModule {
    ...
    public static final String WORKFLOW_SAVE              = "/workflow/save";
    public static final String WORKFLOW_READ_BY_IDENTITY  = "/workflow/readbyid/{id}";
    public static final String WORKFLOW_READ_LIST         = "/workflow/list";
    public static final String WORKFLOW_READ_LIST_BY_TYPE = "/workflow/type/list/{id}";
    public static final String WORKFLOW_READ_LIST_BY_USER = "/workflow/user/list/{id}/{status}";
    public static final String WORKFLOW_SEARCH            = "/workflow/search";
    ...
    public static URI READ_WORKFLOW_BY_IDENTITY_URIBUILDER(final String id) {
  ...
  public static class ProfileModule {
    ...
    public static URI CAL_CACHDATA_USER_DATARESET(final Long companyid, final Long userid) {
