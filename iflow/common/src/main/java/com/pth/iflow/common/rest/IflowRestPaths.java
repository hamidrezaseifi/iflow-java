...
public class IflowRestPaths {
  ...
  public static class ProfileModule {
    ...
    public static final String AUTHENTICATION_READ_AUTHENTOCATEDINFO = "/profile/read/authinfo";
    public static final String AUTHENTICATION_READ_TOKENINFO         = "/profile/read/tokeninfo";
