...
public class IflowRestPaths {
  ...
  public static class ProfileModule {
    ...
    public static URI READ_CACHDATA_USER_WORKFLOWMESSAGELIST(final String companyIdentity, final Long userid) {
      final IflowUriBuilder builder = new IflowUriBuilder(CACHDATA_READ_USER_WORKFLOWMESSAGELIST);
      return builder.build(companyIdentity, userid);
    }
    ...
    public static URI CAL_CACHDATA_USER_DATARESET(final String companyIdentity, final Long userid) {
