...
public class BasicE2eTest {
  ...
  public void testBasic_ReadWOrkflowTypes() throws Exception {
    ...
    final URI uri = com.pth.iflow.common.rest.IflowRestPaths.CoreModule.READ_WORKFLOWTYPE_LIST_BY_COMPANY(1L);

    final WorkflowTypeListEdo list = restTemplate.getForObject(coreUrlHost + uri, WorkflowTypeListEdo.class);
