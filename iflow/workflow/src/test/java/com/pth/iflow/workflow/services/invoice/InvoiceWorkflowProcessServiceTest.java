...
public class InvoiceWorkflowProcessServiceTest extends TestDataProducer {
  ...
  public void testSearchWorkflow() throws Exception {
    ...
    final List<InvoiceWorkflow> workflowListResult = this.getTestInvoiceWorkflowList();
    ...
    final List<InvoiceWorkflow> resWorkflowList = this.workflowProcessService.search(filter, this.validTocken);
