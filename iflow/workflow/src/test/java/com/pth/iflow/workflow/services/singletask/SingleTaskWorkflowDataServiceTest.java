...
public class SingleTaskWorkflowDataServiceTest extends TestDataProducer {
  ...
  public void testGetById() throws Exception {
    ...
    final SingleTaskWorkflow resWorkflow = this.workflowDataService.getByIdentity(workflow.getIdentity(), this.getValidAuthentiocation());
  ...
  public void testSaveWorkflow() throws Exception {
    ...
    final SingleTaskWorkflow resWorkflow = this.workflowDataService.save(workflow, this.getValidAuthentiocation());
  ...
  public void testGetListByIdList() throws Exception {
    ...
    when(this.restTemplate
        .callRestPost(any(URI.class), any(EModule.class), any(Set.class),
            eq(SingleTaskWorkflowListEdo.class), any(String.class), any(boolean.class))).thenReturn(edoList);

    final List<SingleTaskWorkflow> resList = this.workflowDataService.getListByIdentityList(idList, this.getValidAuthentiocation());
