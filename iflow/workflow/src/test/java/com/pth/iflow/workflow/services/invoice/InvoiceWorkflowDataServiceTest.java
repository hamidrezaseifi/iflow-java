...
public class InvoiceWorkflowDataServiceTest extends TestDataProducer {
  ...
  public void testGetById() throws Exception {
    ...
    final InvoiceWorkflow resWorkflow = this.workflowDataService.getByIdentity(workflow.getIdentity(), this.getValidAuthentiocation());
  ...
  public void testSaveWorkflow() throws Exception {
    ...
    final InvoiceWorkflow resWorkflow = this.workflowDataService.save(workflow, this.getValidAuthentiocation());
  ...
  public void testGetListByIdList() throws Exception {
    ...
    when(this.restTemplate
        .callRestPost(any(URI.class), any(EModule.class), any(Set.class),
            eq(InvoiceWorkflowListEdo.class), any(String.class), any(boolean.class))).thenReturn(edoList);

    final List<InvoiceWorkflow> resList = this.workflowDataService.getListByIdentityList(idList, this.getValidAuthentiocation());
