...
public class ArchivingWorkflowStrategyTest extends TestDataProducer {
  ...
  private ArchivingWorkflowStrategy<TestThreeTaskWorkflow> workflowStrategy;
  ...
  public void testProccessStrategy() throws Exception {
    ...
    this.workflowStrategy = new ArchivingWorkflowStrategy<TestThreeTaskWorkflow>(request,
