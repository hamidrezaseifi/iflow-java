...
public class InvoiceWorkflowControllerTest extends TestDataProducer {
  ...
  public void testCreateWorkflow() throws Exception {
    ...
    when(this.workflowService.create(any(InvoiceWorkflowSaveRequest.class), any(String.class))).thenReturn(list);
    ...
    this.mockMvc
                .perform(MockMvcRequestBuilders.post(IflowRestPaths.WorkflowModule.INVOICEWORKFLOW_CREATE)
    ...
    verify(this.workflowService, times(1)).create(any(InvoiceWorkflowSaveRequest.class), any(String.class));
  ...
  public void testSaveWorkflow() throws Exception {
    ...
    when(this.workflowService.save(any(InvoiceWorkflowSaveRequest.class), any(String.class))).thenReturn(result);
    ...
    this.mockMvc
                .perform(MockMvcRequestBuilders.post(IflowRestPaths.WorkflowModule.INVOICEWORKFLOW_SAVE)
                                               .content(contentAsXmlString)
                                               .contentType(MediaType.APPLICATION_XML_VALUE)
                                               .header(TokenVerficationHandlerInterceptor.IFLOW_TOKENID_HEADER_KEY, "test-roken"))
    ...
    verify(this.workflowService, times(1)).save(any(InvoiceWorkflowSaveRequest.class), any(String.class));
  ...
  public void testReadWorkflowList() throws Exception {
    ...
    this.mockMvc
                .perform(MockMvcRequestBuilders.post(IflowRestPaths.WorkflowModule.INVOICEWORKFLOW_READ_LIST)
                                               .content(contentAsXmlString)
                                               .contentType(MediaType.APPLICATION_XML_VALUE)
                                               .header(TokenVerficationHandlerInterceptor.IFLOW_TOKENID_HEADER_KEY, "test-roken"))
                .andExpect(status().isOk())
  ...
  public void testSearchWorkflow() throws Exception {
    ...
    this.mockMvc
                .perform(MockMvcRequestBuilders.post(IflowRestPaths.WorkflowModule.INVOICEWORKFLOW_SEARCH)
                                               .content(contentAsXmlString)
                                               .contentType(MediaType.APPLICATION_XML_VALUE)
                                               .header(TokenVerficationHandlerInterceptor.IFLOW_TOKENID_HEADER_KEY, "test-roken"))
                .andExpect(status().isOk())
  ...
  public void testValidateWorkflow() throws Exception {
    ...
    this.mockMvc.perform(MockMvcRequestBuilders.post(IflowRestPaths.WorkflowModule.INVOICEWORKFLOW_VALIDATE)
                                               .content(contentAsXmlString)
                                               .contentType(MediaType.APPLICATION_XML_VALUE)
                                               .header(TokenVerficationHandlerInterceptor.IFLOW_TOKENID_HEADER_KEY, "test-roken"))
                .andExpect(status().isAccepted());

    verify(this.workflowService, times(1)).validate(any(InvoiceWorkflowSaveRequest.class), any(String.class));
