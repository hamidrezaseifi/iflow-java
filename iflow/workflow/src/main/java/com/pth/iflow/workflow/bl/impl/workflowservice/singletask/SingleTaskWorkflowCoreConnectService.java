...
public class SingleTaskWorkflowCoreConnectService implements IWorkflowDataService<SingleTaskWorkflow> {
  ...
  @Override
  public List<SingleTaskWorkflow> getListByIdentityList(final Set<String> idList, final String token) throws WorkflowCustomizedException, MalformedURLException, IFlowMessageConversionFailureException {
  ...
  @Override
  public SingleTaskWorkflow save(final SingleTaskWorkflow model, final String token) throws WorkflowCustomizedException, MalformedURLException, IFlowMessageConversionFailureException {
