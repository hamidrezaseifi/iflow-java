...
public class TestThreeTaskWorkflowSaveStrategyFactory implements IWorkflowSaveStrategyFactory<TestThreeTaskWorkflow> {
  ...
  @Override
  public IWorkflowSaveStrategy<TestThreeTaskWorkflow> selectSaveWorkStrategy(final IWorkflowSaveRequest<TestThreeTaskWorkflow> workflowSaveRequest, final String token) throws WorkflowCustomizedException, MalformedURLException, IFlowMessageConversionFailureException {
  ...
  @Override
  public IWorkflowSaveStrategy<TestThreeTaskWorkflow> selectValidationWorkStrategy(final IWorkflowSaveRequest<TestThreeTaskWorkflow> workflowSaveRequest, final String token) throws WorkflowCustomizedException, MalformedURLException, IFlowMessageConversionFailureException {
