...
public class InvoiceController {
  ...
  public ResponseEntity<InvoiceWorkflowListEdo> createInvoice(
    ...
    final List<InvoiceWorkflow> modelList = this.invoiceWorkflowService
        .create(WorkflowModelEdoMapper.fromEdo(workflowCreateRequestEdo), headerTokenId);

    return ControllerHelper.createResponseEntity(request,
        new InvoiceWorkflowListEdo(WorkflowModelEdoMapper.toWorkflowEdoList(modelList)), HttpStatus.CREATED);
  }
  ...
  public ResponseEntity<InvoiceWorkflowListEdo> readInvoiceList(@RequestBody final Set<String> idList,
    ...
    return ControllerHelper.createResponseEntity(request,
        new InvoiceWorkflowListEdo(WorkflowModelEdoMapper.toWorkflowEdoList(modelList)), HttpStatus.OK);
  }
  ...
  public ResponseEntity<InvoiceWorkflowListEdo> searchInvoice(@RequestBody final WorkflowSearchFilterEdo workflowSearchFilterEdo,
      final HttpServletRequest request,
      @RequestHeader(TokenVerficationHandlerInterceptor.IFLOW_TOKENID_HEADER_KEY) final String headerTokenId) throws Exception {
