...
public class TestThreeTaskWorkflowCoreConnectService implements IWorkflowDataService<TestThreeTaskWorkflow> {
  ...
  @Override
  public List<TestThreeTaskWorkflow> getListByIdentityList(final Set<String> idList, final String token) throws WorkflowCustomizedException, MalformedURLException, IFlowMessageConversionFailureException {
  ...
  @Override
  public TestThreeTaskWorkflow save(final TestThreeTaskWorkflow model, final String token) throws WorkflowCustomizedException, MalformedURLException, IFlowMessageConversionFailureException {
