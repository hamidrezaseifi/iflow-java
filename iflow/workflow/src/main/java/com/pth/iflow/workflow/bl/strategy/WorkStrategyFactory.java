...
public class WorkStrategyFactory implements IWorkStrategyFactory {
  ...
  @Override
  public IWorkflowSaveStrategy selectSaveWorkStrategy(final WorkflowSaveRequest workflowSaveRequest, final String token) throws WorkflowCustomizedException, MalformedURLException, IFlowMessageConversionFailureException {
    ...
    if (workflowSaveRequest.isArchiveCommand()) {
      ...
      return new ArchivingWorkflowStrategy(workflowSaveRequest,
                                           token,
                                           departmentDataService,
                                           workflowMessageDataService,
                                           cachDataDataService,
    ...
    if (workflowSaveRequest.isSaveCommand()) {
      ...
      return new SaveExistingWorkflowStrategy(workflowSaveRequest,
                                              token,
                                              departmentDataService,
                                              workflowMessageDataService,
                                              cachDataDataService,
    ...
    if (workflowSaveRequest.isAssignCommand()) {
      ...
      return new AssignWorkflowStrategy(workflowSaveRequest,
                                        token,
                                        departmentDataService,
                                        workflowMessageDataService,
                                        cachDataDataService,
    ...
    if (workflowSaveRequest.isDoneCommand()) {
      ...
      return new DoneExistingWorkflowStrategy(workflowSaveRequest,
                                              token,
                                              departmentDataService,
                                              workflowMessageDataService,
                                              cachDataDataService,
  ...
  @Override
  public IWorkflowSaveStrategy selectValidationWorkStrategy(final WorkflowSaveRequest workflowSaveRequest, final String token) throws WorkflowCustomizedException, MalformedURLException, IFlowMessageConversionFailureException {
    ...
    if (workflowSaveRequest.isCreateCommand()) {
      if (workflowSaveRequest.getWorkflow().getWorkflowType().isAssignTypeManual()) {
        ...
        return new CreateManualAssignWorkflowValidationStrategy(workflowSaveRequest,
                                                                token,
                                                                departmentDataService,
                                                                workflowMessageDataService,
                                                                cachDataDataService,
      ...
      if (workflowSaveRequest.getWorkflow().getWorkflowType().isAssignTypeOffering()) {
        ...
        return new CreateOfferlAssignWorkflowValidationStrategy(workflowSaveRequest,
                                                                token,
                                                                departmentDataService,
                                                                workflowMessageDataService,
                                                                cachDataDataService,
    ...
    if (workflowSaveRequest.isArchiveCommand()) {
      ...
      return new ArchivingWorkflowValidationStrategy(workflowSaveRequest,
                                                     token,
                                                     departmentDataService,
                                                     workflowMessageDataService,
                                                     cachDataDataService,
    ...
    if (workflowSaveRequest.isSaveCommand()) {
      ...
      return new SaveExistingWorkflowValidationStrategy(workflowSaveRequest,
                                                        token,
                                                        departmentDataService,
                                                        workflowMessageDataService,
                                                        cachDataDataService,
    ...
    if (workflowSaveRequest.isAssignCommand()) {
      ...
      return new AssignWorkflowValidationStrategy(workflowSaveRequest,
                                                  token,
                                                  departmentDataService,
                                                  workflowMessageDataService,
                                                  cachDataDataService,
    ...
    if (workflowSaveRequest.isDoneCommand()) {
      ...
      return new DoneExistingWorkflowValidationStrategy(workflowSaveRequest,
                                                        token,
                                                        departmentDataService,
                                                        workflowMessageDataService,
                                                        cachDataDataService,
