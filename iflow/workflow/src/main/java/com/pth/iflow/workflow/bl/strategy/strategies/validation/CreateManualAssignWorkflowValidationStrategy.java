...
public class CreateManualAssignWorkflowValidationStrategy extends AbstractWorkflowSaveStrategy {

  public CreateManualAssignWorkflowValidationStrategy(final WorkflowSaveRequest workflowCreateRequest, final String token,
