...
public class InvoiceWorkflowSaveStrategyFactory implements IWorkflowSaveStrategyFactory<InvoiceWorkflow> {
  ...
  @Override
  public IWorkflowSaveStrategy<InvoiceWorkflow> selectSaveWorkStrategy(final IWorkflowSaveRequest<InvoiceWorkflow> workflowSaveRequest, final String token) throws WorkflowCustomizedException, MalformedURLException, IFlowMessageConversionFailureException {
  ...
  @Override
  public IWorkflowSaveStrategy<InvoiceWorkflow> selectValidationWorkStrategy(final IWorkflowSaveRequest<InvoiceWorkflow> workflowSaveRequest, final String token) throws WorkflowCustomizedException, MalformedURLException, IFlowMessageConversionFailureException {
