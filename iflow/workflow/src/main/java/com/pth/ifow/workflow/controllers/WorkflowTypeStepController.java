...
public class WorkflowTypeStepController {
  ...
  @GetMapping(path = IflowRestPaths.WorkflowModule.WORKFLOWTYPESTEP_READ_BY_ID, produces = {
  ...
  @ResponseStatus(HttpStatus.OK)
  @PostMapping(path = IflowRestPaths.WorkflowModule.WORKFLOWTYPESTEP_READ_LIST, produces = {
      MediaType.APPLICATION_XML_VALUE,
