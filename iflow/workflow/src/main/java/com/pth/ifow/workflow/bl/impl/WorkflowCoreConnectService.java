...
@Service
public class WorkflowCoreConnectService implements IWorkflowService {
  ...
  public Workflow getById(final Long id) throws WorkflowCustomizedException, MalformedURLException {
    ...
    final WorkflowEdo edo = restTemplate.callRestGet(
        moduleAccessConfig.generateCoreUrl(IflowRestPaths.CoreModul.WORKFLOW_READ_BY_ID).toString(), EModule.CORE, WorkflowEdo.class,
        true, id);
  ...
  public List<Workflow> getListByIdList(final List<Long> idList) throws WorkflowCustomizedException, MalformedURLException {
    ...
    final List<WorkflowEdo> edoList = restTemplate.callRestPost(
        moduleAccessConfig.generateCoreUrl(IflowRestPaths.CoreModul.WORKFLOW_READ_LIST).toString(), EModule.CORE, idList, typeRef,
        true);
  ...
  public Workflow save(final Workflow model) throws WorkflowCustomizedException, MalformedURLException {
    ...
    final WorkflowEdo edo = restTemplate.callRestPost(
        moduleAccessConfig.generateCoreUrl(IflowRestPaths.CoreModul.WORKFLOW_SAVE).toString(), EModule.CORE, model, WorkflowEdo.class,
        true);
  ...
  public List<Workflow> getListByTypeId(final Long id) throws WorkflowCustomizedException, MalformedURLException {
    ...
    final List<WorkflowEdo> edoList = restTemplate.callRestGet(
        moduleAccessConfig.generateCoreUrl(IflowRestPaths.CoreModul.WORKFLOW_READ_LIST_BY_TYPE).toString(), EModule.CORE, typeRef,
        true, id);
  ...
  public List<Workflow> getListForUser(final Long id, final int status) throws WorkflowCustomizedException, MalformedURLException {
    ...
    final List<WorkflowEdo> edoList = restTemplate.callRestGet(
        moduleAccessConfig.generateCoreUrl(IflowRestPaths.CoreModul.WORKFLOW_READ_LIST_BY_USER).toString(), EModule.CORE, typeRef,
        true, id, status);
