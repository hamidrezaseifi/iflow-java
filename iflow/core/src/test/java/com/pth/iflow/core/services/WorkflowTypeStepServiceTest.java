...
public class WorkflowTypeStepServiceTest extends TestDataProducer {
  ...
  public void testGetListByIdList() throws Exception {
    ...
    final Set<WorkflowTypeStep> resList = this.workflowTypeStepService.getListByIdentityList(idList);
  ...
  public void testGetListByWorkflowTypeId() throws Exception {
    ...
    final Set<WorkflowTypeStep> resList = this.workflowTypeStepService.getListByWorkflowTypeId(1L);
