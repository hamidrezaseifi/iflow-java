...
public class UserDao extends DaoBasicClass<User> implements IUserDao {
  ...
  @Override
  public Set<User> getListByIdList(final Set<Long> idList) throws IFlowStorageException {
  ...
  @Override
  public Set<User> getListByIdentityList(final Set<String> idList) throws IFlowStorageException {
  ...
  @Override
  public Set<User> getListByCompanyId(final Long id) throws IFlowStorageException {
    final Set<Long> idList = this.getIdListById(id, "SELECT * FROM users where company_id=?", "id", "User");
