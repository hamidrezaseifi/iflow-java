...
public class WorkflowActionDao extends DaoBasicClass<WorkflowAction> implements IWorkflowActionDao {
  ...
  @Override
  public Set<WorkflowAction> getListByIdList(final Set<Long> idList) throws IFlowStorageException {
  ...
  @Override
  public Set<WorkflowAction> getListByWorkflowId(final Long id) throws IFlowStorageException {
