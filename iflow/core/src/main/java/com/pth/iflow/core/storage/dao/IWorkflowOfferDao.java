...
public interface IWorkflowOfferDao {
  ...
  public List<WorkflowOffer> getListByUserId(Long userId) throws IFlowStorageException;

  public List<WorkflowOffer> getListByWorkflowId(Long workflowId) throws IFlowStorageException;
