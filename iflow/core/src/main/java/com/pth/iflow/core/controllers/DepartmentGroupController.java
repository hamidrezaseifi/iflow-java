...
public class DepartmentGroupController {
  ...
  public ResponseEntity<Set<DepartmentGroupEdo>> readDepartmentList(@RequestBody final Set<String> idList,
      final HttpServletRequest request) throws Exception {

    final Set<DepartmentGroup> modelList = this.departmentGroupService.getListByIdentityList(idList);

    return ControllerHelper.createResponseEntity(request, CoreModelEdoMapper.toDepartmentGroupEdoSet(modelList), HttpStatus.OK);
  }
  ...
  public ResponseEntity<DepartmentGroupListEdo> readDepartmentListByDepartment(@PathVariable final Long id,
    ...
    final Set<DepartmentGroup> modelList = this.departmentGroupService.getListByDepartmentId(id);

    return ControllerHelper.createResponseEntity(request,
        new DepartmentGroupListEdo(CoreModelEdoMapper.toDepartmentGroupEdoSet(modelList)), HttpStatus.OK);
  }
  ...
  public ResponseEntity<UserListEdo> readAllUserListByDepartmentGroup(@PathVariable final Long id, final HttpServletRequest request)
    ...
    final Set<User> modelList = this.departmentGroupService.getAllUserListByDepartmentGroupId(id);
