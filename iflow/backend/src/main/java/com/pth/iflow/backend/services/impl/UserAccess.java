...
public class UserAccess implements IUserAccess {
  ...
  @Override
  public User readUser(final String userId) throws BackendCustomizedException, MalformedURLException {
    // TODO Auto-generated method stub
    return null;
  }

  @Override
  public User saveUser(final User user) throws BackendCustomizedException, MalformedURLException {
    // TODO Auto-generated method stub
    return null;
  }

  @Override
  public List<User> readCompanyUserList(final String companyId) throws MalformedURLException, IFlowMessageConversionFailureException {
