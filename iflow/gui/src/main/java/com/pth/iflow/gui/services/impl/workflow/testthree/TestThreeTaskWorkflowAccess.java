...
public class TestThreeTaskWorkflowAccess implements IWorkflowAccess<TestThreeTaskWorkflow, TestThreeTaskWorkflowSaveRequest> {
  ...
  @Override
  public TestThreeTaskWorkflow readWorkflow(final String workflowIdentity, final String token) throws GuiCustomizedException, MalformedURLException, IFlowMessageConversionFailureException {

    final TestThreeTaskWorkflowEdo responseEdo =
                                               this.restTemplate.callRestGet(this.moduleAccessConfig.getReadTestThreeTaskWorkflowUri(workflowIdentity),
                                                                             EModule.WORKFLOW,
  ...
  @Override
  public List<TestThreeTaskWorkflow> createWorkflow(final TestThreeTaskWorkflowSaveRequest createRequest, final String token) throws GuiCustomizedException, MalformedURLException, IFlowMessageConversionFailureException {
    logger.debug("Create workflow");

    final TestThreeTaskWorkflowListEdo responseListEdo =
                                                       this.restTemplate.callRestPost(this.moduleAccessConfig.getCreateTestThreeTaskWorkflowUri(),
                                                                                      EModule.WORKFLOW,
  ...
  @Override
  public TestThreeTaskWorkflow saveWorkflow(final TestThreeTaskWorkflowSaveRequest request, final String token) throws GuiCustomizedException, MalformedURLException, IFlowMessageConversionFailureException {
  ...
  @Override
  public List<TestThreeTaskWorkflow> searchWorkflow(final WorkflowSearchFilter workflowSearchFilter, final String token) throws GuiCustomizedException, MalformedURLException, IFlowMessageConversionFailureException {
    logger.debug("Search workflow");

    final TestThreeTaskWorkflowListEdo responseListEdo =
                                                       this.restTemplate.callRestPost(this.moduleAccessConfig.getSearchTestThreeTaskWorkflowUri(),
                                                                                      EModule.WORKFLOW,
  ...
  @Override
  public void validateWorkflow(final TestThreeTaskWorkflowSaveRequest request, final String token) throws GuiCustomizedException, MalformedURLException, IFlowMessageConversionFailureException {
    logger.debug("save workflow");

    this.restTemplate.callRestPost(this.moduleAccessConfig.getValidateTestThreeTaskWorkflowUri(),
                                   EModule.WORKFLOW,
                                   GuiModelEdoMapper.toEdo(request),
                                   Void.class,
                                   token,
