...
public interface IWorkflowAccess<W extends IWorkflow, WS extends IWorkflowSaveRequest<W>> {
  ...
  W readWorkflow(final String workflowIdentity, final String token) throws GuiCustomizedException, MalformedURLException, IFlowMessageConversionFailureException;
