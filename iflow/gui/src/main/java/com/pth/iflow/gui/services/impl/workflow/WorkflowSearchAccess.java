...
public class WorkflowSearchAccess implements IWorkflowSearchAccess {
  ...
  public List<Workflow> searchWorkflow(final WorkflowSearchFilter workflowSearchFilter)
    ...
    final WorkflowListEdo responseListEdo = this.restTemplate
        .callRestPost(this.moduleAccessConfig.getSearchWorkflowUri(), EModule.WORKFLOW,
  ...
  public List<Workflow> readByIdentityList(final Set<String> identityList)
    ...
    final WorkflowListEdo responseListEdo = this.restTemplate
        .callRestPost(this.moduleAccessConfig.getReadWorkflowListByIdentityListUri(),
    ...
    resultWorkflow
        .setCurrentStep(
            this.sessionUserInfo
                .getWorkflowStepTypeByIdentity(resultWorkflow.getWorkflowTypeIdentity(), resultWorkflow.getCurrentStepIdentity()));
