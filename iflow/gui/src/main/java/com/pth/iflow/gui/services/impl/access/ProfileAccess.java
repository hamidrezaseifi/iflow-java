...
public class ProfileAccess implements IProfileAccess {
  ...
  public ProfileResponse isTokenValid(final String token)
    ...
    profileRequest.setAppId(EApplication.IFLOW.getIdentity());

    final ProfileResponseEdo responseEdo = this.restTemplate
        .callRestPost(this.moduleAccessConfig.getReadTokenInfoUri(),
            EModule.PROFILE,
            profileRequest,
  ...
  public UserAuthenticationResponse authenticate(final String username, final String password, final String companyIdentity)
    ...
    request.setAppId(EApplication.IFLOW.getIdentity());

    final UserAuthenticationResponseEdo responseEdo = this.restTemplate
        .callRestPost(this.moduleAccessConfig.getAuthenticationUri(),
            EModule.PROFILE,
            request,
  ...
  public ProfileResponse readProfile(final String username, final String token)
    ...
    final ProfileResponseEdo responseEdo = this.restTemplate
        .callRestPost(this.moduleAccessConfig.getReadAuthenticationInfoUri(),
            EModule.PROFILE,
            request,
            ProfileResponseEdo.class,
            token,
