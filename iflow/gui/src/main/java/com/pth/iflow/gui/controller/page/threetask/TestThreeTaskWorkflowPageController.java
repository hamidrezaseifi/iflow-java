package com.pth.iflow.gui.controller.page.threetask;
...
public class TestThreeTaskWorkflowPageController extends GuiPageControllerBase {

  @Autowired
  private IWorkflowHandler<TestThreeTaskWorkflow, TestThreeTaskWorkflowSaveRequest> invoiceWorkflowHandler;
