...
public class UserAccess implements IUserAccess {
  ...
  @Override
  public List<GuiUser> getCompanyUserList(final Long companyId) throws GuiCustomizedException, MalformedURLException, IFlowMessageConversionFailureException {
