...
public class WorkflowPageController extends GuiPageControllerBase {
  ...
  public String showWorkflowEdit(final Model model, @PathVariable(required = false) final Long workflowId, final HttpServletResponse response) throws GuiCustomizedException, IOException, IFlowMessageConversionFailureException {
  ...
  public void viewWorkflowFile(final Model model, @PathVariable(required = true) final Long fileId, @PathVariable(required = true) final Long workflowId, final HttpServletResponse response) throws GuiCustomizedException, IOException, IFlowMessageConversionFailureException {
  ...
  @ResponseBody
  public ResponseEntity<InputStreamResource> downloadWorkflowFile(final Model model, @PathVariable(required = true) final Long fileId, @PathVariable(required = true) final Long workflowId, final HttpServletResponse response) throws GuiCustomizedException, IOException, IFlowMessageConversionFailureException {
  ...
  public void processMessage(final Model model, @PathVariable(required = true) final Long id, final HttpServletResponse response) throws GuiCustomizedException, IOException, IFlowMessageConversionFailureException {
