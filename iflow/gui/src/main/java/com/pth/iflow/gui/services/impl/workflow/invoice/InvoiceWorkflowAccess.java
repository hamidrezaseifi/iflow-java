...
public class InvoiceWorkflowAccess implements IWorkflowAccess<InvoiceWorkflow, InvoiceWorkflowSaveRequest> {
  ...
  @Override
  public InvoiceWorkflow readWorkflow(final String workflowIdentity, final String token) throws GuiCustomizedException, MalformedURLException, IFlowMessageConversionFailureException {

    final InvoiceWorkflowEdo responseEdo =
                                         this.restTemplate.callRestGet(this.moduleAccessConfig.getReadInvoiceWorkflowUri(workflowIdentity),
                                                                       EModule.WORKFLOW,
  ...
  @Override
  public List<InvoiceWorkflow> createWorkflow(final InvoiceWorkflowSaveRequest createRequest, final String token) throws GuiCustomizedException, MalformedURLException, IFlowMessageConversionFailureException {
  ...
  @Override
  public InvoiceWorkflow saveWorkflow(final InvoiceWorkflowSaveRequest request, final String token) throws GuiCustomizedException, MalformedURLException, IFlowMessageConversionFailureException {
  ...
  public void validateWorkflow(final InvoiceWorkflowSaveRequest request, final String token) throws GuiCustomizedException, MalformedURLException, IFlowMessageConversionFailureException {
    ...
    this.restTemplate.callRestPost(this.moduleAccessConfig.getValidateInvoiceWorkflowUri(),
                                   EModule.WORKFLOW,
                                   GuiModelEdoMapper.toEdo(request),
                                   Void.class,
                                   token,
