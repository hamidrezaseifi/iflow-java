(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
            ...
            var WorkflowEditService = /** @class */ (function () {
                ...
                WorkflowEditService.prototype.loadCreateInitialData = function () {
                    ...
                    this.http.post(this.initCreateUrl, new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"](), httpOptions).subscribe(function (initialData) {
                        ...
                        _this.workflowSaveRequest = JSON.parse(JSON.stringify(initialData));
                        _this.workflowSaveRequestSubject.next(initialData);
                    }, function (response) {
                        console.log("Error in read create inital data", response);
                    }, function () {
                        _this.workflowSaveRequestSubject.complete();
                        _this.loadingService.hideLoading();
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CreateSingletaskComponent = /** @class */ (function () {
                function CreateSingletaskComponent(router, global, translate, editService, loadingService) {
                    var _this = this;
                    this.router = router;
                    this.global = global;
                ...
                CreateSingletaskComponent.prototype.subscribeToSearchInitialData = function () {
                    var _this = this;
                    this.editService.workflowSaveRequestSubject.subscribe(function (data) {
                        console.log("set gloabl-data from workflow-create. : ", data);
                        //alert("from app-comp: \n" + JSON.stringify(data));
                        if (data && data !== null) {
                            _this.workflowSaveRequest = data;
                        }
                        else {
