...
public class TestThreeTaskWorkflowAccessTest extends TestDataProducer {
  ...
  public void setUp() throws Exception {
    ...
    when(this.workflowModuleAccessConfig.getSearchTestThreeTaskWorkflowUri()).thenReturn(this.testUri);
  ...
  public void testSearchWorkflow() throws Exception {
    ...
    final List<TestThreeTaskWorkflow> resWorkflowList = this.workflowAccess.searchWorkflow(searchFilter, this.testToken);
